  ...
  return (
    <div className={`px-3 flex flex-col gap-3`}>
      <div
        ...
        h-32 flex flex-col items-center justify-center gap-1 data-[active=true]:bg-indigo-500/10
        data-[active=true]:border-indigo-500 data-[active=true]:text-indigo-400"
        {...getRootProps()}
      >
